...
estrategia = Estrategia(  # Passe os requisitos do FII
...
for linha in linhas:
    ...
    fundo_imobiliario = FundoImobiliario(codigo, segmento, cotacao, ffo_yield, dividend_yield,
                                        p_vp, valor_mercado, liquidez, qt_imoveis, preco_m2, aluguel_m2, cap_rate, vacancia)
...
print(tabulate_function(tabela, headers=cabecalho, showindex='always', tablefmt='fancy_grid'))
